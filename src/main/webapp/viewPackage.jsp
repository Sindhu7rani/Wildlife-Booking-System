...
<%
            ...
            else if (name.equalsIgnoreCase("Riverfront Bamboo Cottage Package")) {
            	%>
            	 <li>Stay in Riverside Bamboo Cottage (8 cottages available)</li>
  				 <li>Includes all meals (Lunch, Dinner, Breakfast) + Evening Snacks</li>
  				 <li>1 Boat Safari + 1 Jeep Safari</li>
  				 <li>Kayaking session included</li>
 				 <li>Forest Entry + GST included</li>
  				 <li>Peaceful ambiance, ideal for couples</li>
  				 <li>30% extra for single occupancy</li>
  				 <li>Camera charges extra, seasonal hike applicable</li>
            	<%
            	            }
