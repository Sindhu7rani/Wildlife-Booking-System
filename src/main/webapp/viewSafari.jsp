...
<head>
    <meta charset="UTF-8">
    <title>Wildlife Safari Services</title>
...
<h1>Wildlife Safari Services</h1>
...
%>
    <div class="safari-box">
        ...
        <h4>₹<%= price %> / seat</h4>
     <div class="buttons">
    <a href="updateSafari.jsp?id=<%= id %>" class="update-btn">Update</a>
    
    <form action="SafariAction" method="post" onsubmit="return confirm('Are you sure you want to delete this Safari?');" style="display:inline;">
        <input type="hidden" name="action" value="delete">
        <input type="hidden" name="safariId" value="<%= id %>">
